...
import { verifyPasswordResetCode, verifyResetCodeSchema } from "@/modules/auth";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await verifyPasswordResetCode(validatedData);
